...
Entire project is done in 1 python file ( maxprofit.py )
...
The project is a streamlit program as seen below, depending on input given by user, the output will be given 
